    ...
    <div className="App">
      ...
      <div className="last_sec">
        ...
        <div className="last_first">
          <Hocrux1 text={<>Read about our blogs for more <br />information on our processes</>} />

          <Jobber text={<>How to start a company
                <br />
                formation in Dubai</>} time={`5 Minutes`} link={banner12} />
          ...
          <Hocrux1 text={<>Satisfied We are When Our <br /> Customers Are Happy{" "}</>} />

          {/* comments */}

          <div className='comment'>
          <div>
                               <img className='comment_img' src={banner13}/>
                            </div>
                            <div className=''>
                              <h1 className='com_mes'>"I am very happy with them. I'll <br/>
                                continue to use their services in <br/>
                                future & highly recommend them <br/>
                                to anyone,"
                              </h1>
                              <h1 className='com_name'>Muhib Abrar</h1>
                            </div>
                           </div>
        ...
        <Hocrux1 text={<>Get to know the whole us and <br />
