...
function App() {
  ...
  const ColumnArr = [
    ...
    { name: `RAK ICC`, amt: `$2,997`, type: `One Time Payment`, add: `Rak Icc New Company formation
    includes`, feat: ["Attestation Charges" , "Registered Agent" ,"Registered Office"] },
    { name: ``, amt: ``, type: ``, add: ``, feat: [] },
  ];
