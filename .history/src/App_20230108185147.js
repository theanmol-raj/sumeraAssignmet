  ...
  return (
    <div className="App">
      ...
      <div className="column">
       ...
       <Card title={'Advice & Guidanc'} text={<>All activities in the UAE are licensed.<br/>
...
insightfull guidance today</>} />
        ...
        <Card title={'UAE Company Visas'} text={<>Your application for visas is critical<br/>
...
matters most to you.</>} />
       ...
       <Card title={'Registration Document Perparation'} 
       text={<>There are many banks in the United <br/>
       Arab Emirates [UAE]. Both locally <br/>
       owned and branches of <br/>
       multinational ones. Foreign banks <br/> 
       adjust according to their parent s <br/>
