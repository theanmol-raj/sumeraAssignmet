...
function App() {
  ...
  a conclusion that meets your objectives of investing in the UAE.`,
    ...
    { title: `Dubai Local Companies`, text: `The Dubai LLC formation documents are actually articles of organization or a certificate of organization. You can get yours today.`, icon: `` },
    { title: `Offshore Compamies`, text: `You can register an offshore company
  ...
  return (
    <div className="App">
      ...
      <div className="main">
      {Dedicated.map(({title ,text ,icon} ,index) => <SmallCard title={title} key={index} text={text} icon={icon}  />)}
