    ...
    <div className='App' >
        ...
        {/* Search button */}
         ...
         {/* Content and image */}
            ...
            <div style={{display : "flex" , margin:"0 auto" , alignItems : "center" ,fontWeight : "600" ,marginTop : "60px" ,color:"rgba(15, 89, 218, 0.87)"}} className='flex mx-auto items-center space-x-2 text-lg font-semibold text-blue-600 mt-[60px]'>
