    ...
    <div className='App' >
        ...
        {/* Search button */}
            <div className='serbox' >
               <div className='serbody' >
                 ...
                 <input className='ser_inp' type='text' placeholder='Search A Term | Topic'></input>
                </div>
            </div>
         ...
         {/* Content and image */}
            ...
            <div className='contImg' >
                <div className='co1'>
                    ...
                    <h2 className='A'>Get started on fulfilling <br/> your Dubai or UAE <br/>dream.</h2>
                    <h2 className='B'>UAE & Offshore Company</h2>
                    <h2 className='C'>We provide you with information about UAE or 
            ...
            <div style={{display : "flex" , margin:"0 auto" , alignItems : "center" ,fontWeight : "600" ,marginTop : "60px" ,color:"rgba(15, 89, 218, 0.87)" , fontSize : "large"}} className='flex mx-auto items-center space-x-2 text-lg font-semibold text-blue-600 mt-[60px]'>
            ...
            <div className='quotes '>
              <h1 className='quotes1'>Dedicated<br/>
                  <span className=''>to our mission we are</span></h1>
              <p className=' quotes2'>Our services include Company Formation & Renewals,<br/> 
            ...
            <div className='column1'>
                <div className='col_1'>
                    <p className='col_line'>Learn the ways in which you can benefit <br/>
            ...
            <div className='col_2'>
                    <p className='col2_content'>We have gathered a team of <br/>
        ...
        <div className='bigcolumn'>
            ...
            <div className='big_1_1'>
                ...
                <h1 className='big_rs'>$2,997 <span className='one_time'>One Time Payment</span></h1>
                 <h1 className='big_mini_head'>Ajman Offshore New Company <br/>
